...
export class CacheFactory {
  private static _caches = Object.create(null) as {
    [name: string]: BasicLRUCache;
  };
  ...
  static createCache(name: string, recordsLimit?: any): BasicLRUCache {
    CacheFactory._caches[name] = new BasicLRUCache(
      recordsLimit || CacheFactory.recordsLimit
    );
    return CacheFactory._caches[name];
  }
}
