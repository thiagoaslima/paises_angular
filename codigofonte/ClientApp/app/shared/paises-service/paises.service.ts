...
export class PaisesService extends RequestService {
    ...
    getSintese(siglaPais: string) {
        ...
        const url = `https://servicodados.ibge.gov.br/api/v1/pesquisas/${PaisesEnum.pesquisaId}/indicadores/1/resultados/${siglaPais}`;
    ...
    getMetadataIndicador(indicadorId: number, scope = "sub") {
        ...
        return this.request(
            `https://servicodados.ibge.gov.br/api/v1/pesquisas/${PaisesEnum.pesquisaId}/indicadores/${indicadorId}`,
            metadataParams
        ).pipe(
            map(metadata =>
    ...
    getTodosDados(siglaPais: string) {
        ...
        const resultadosObservable = this.request(
            `https://servicodados.ibge.gov.br/api/v1/pesquisas/${PaisesEnum.pesquisaId}/indicadores/0/resultados/${siglaPais}`
        );
    ...
    getRanking(
        ...
        return periodoMaisRecente.pipe(
            switchMap(periodo =>
                this.request(
                    `https://servicodados.ibge.gov.br/api/v1/pesquisas/${PaisesEnum.pesquisaId}/periodos/${period ||
    ...
    toResultadoModel(
        ...
        let periodos = periodosResultados || periodosMetadata;
