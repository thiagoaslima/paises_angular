...
export { PaisesService, ConsultaResultado, TipoServico } from './paises.service';
export { PesquisasService, RetornoPesquisa } from './pesquisas.service';
export { MetadataResultado, Resultado } from './resultado.model';
